  ...
  return (
    <>
      <Navbar fluid rounded className="bg-white shadow-md p-4">
        <Navbar.Brand href="#">
          <span className="self-center whitespace-nowrap text-2xl font-semibold text-gray-800">Nome Barbearia</span>
        </Navbar.Brand>
        <div className="flex items-center gap-4 md:order-2">
          ...
          >
            <Dropdown.Header>
              <span className="block text-sm font-medium text-gray-800">Bonnie Green</span>
          ...
          <div className="hidden md:flex flex-col">
            <span className="block text-sm font-medium text-gray-800">Bonnie Green</span>
            <span className="block text-sm text-gray-600">Admin</span>
          </div>
        </div>
        <div className="hidden md:flex md:items-center md:order-1">
          <span className="text-gray-600 text-sm">Sexta-feira, 5 de abril</span>
        </div>
      </Navbar>
